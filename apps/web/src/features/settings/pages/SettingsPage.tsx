  ...
  return (
    <section className="mx-auto max-w-2xl">
      ...
      >
        ...
        <div className="border-t border-line bg-canvas/60 p-4 sm:px-6">
          <button
            type="submit"
          ...
          >
            <Save size={17} />
            {updateStyleProfile.isPending ? '저장 중...' : '스타일 프로필 저장'}
          </button>
        </div>
      </form>
...
export function StyleProfilePage() {
  ...
  return <StyleProfileForm key={meQuery.dataUpdatedAt || 'local'} initialProfile={initialProfile} />
}
